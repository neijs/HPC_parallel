...
void compute_Ap(CGParams *cg_params, double *Ap, double *p) {
    ...
    clock_t end    = clock();
    total_Ap_time += (double)(end - start)/CLOCKS_PER_SEC;
}
...
void compute_Z(CGParams *cg_params, double *z, double *r) {
    ...
    clock_t end   = clock();
    total_Z_time += (double)(end - start)/CLOCKS_PER_SEC;
}
...
double dot(CGParams *cg_params, double *v, double *w) {
    ...
    clock_t end   = clock();
    total_dot_time += (double)(end - start)/CLOCKS_PER_SEC;
...
void array_sumc(double *v, double *w, double *sumc, int size, double coef) {
    ...
    clock_t end   = clock();
    total_sumc_time += (double)(end - start)/CLOCKS_PER_SEC;
}
...
double compute_cg_energy(CGParams *cg_params, double *r, double *w) {
    ...
    clock_t end   = clock();
    total_energy_time += (double)(end - start)/CLOCKS_PER_SEC;
    return -0.5*energy;
}
...
int main() {
    ...
    double params_time = (double)(end_params - start_params)/CLOCKS_PER_SEC;
    double cg_time     = (double)(end_cg - start_cg)/CLOCKS_PER_SEC;
